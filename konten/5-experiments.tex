...
\centering
    ...
    \hline
    \includegraphics[scale=0.6]{gambar/nimbro-1.png} & \includegraphics[scale=0.33]{gambar/rcnn-1.png} & \includegraphics[scale=0.46]{gambar/yolo-1.png} \\
    \hline
    \includegraphics[scale=0.6]{gambar/nimbro-3.png} & \includegraphics[scale=0.34]{gambar/rcnn-3.png} & \includegraphics[scale=0.47]{gambar/yolo-3.png} \\
    \hline
    \end{tabular}
...
\begin{figure*}
\centering
\subfloat[Human Image A]{\includegraphics[width=.22\textwidth]{gambar/human_10_result.jpg}
    \label{fig:humanimagea}}
\hfil
\subfloat[Robot Image A]{\includegraphics[width=.22\textwidth]{gambar/robot_6_result.jpg}
...
\begin{figure*}
\centering
\subfloat[Human Image B]{\includegraphics[width=.22\textwidth]{gambar/human_6_result.jpg}
    \label{fig:humanimageb}}
\hfil
\subfloat[Robot Image B]{\includegraphics[width=.22\textwidth]{gambar/robot_6_result.jpg}
